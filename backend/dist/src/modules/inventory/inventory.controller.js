...
let InventoryController = class InventoryController {
    ...
    async adjustInventory(productId, adjustmentType, quantity, reason, transactionId, req) {
        const userRole = req.user.role;
        if (userRole !== 'ADMIN') {
            throw new common_1.ForbiddenException('Acceso denegado: Solo el rol ADMIN puede realizar ajustes manuales de inventario.');
        }
...
__decorate([
    ...
    __param(1, (0, common_1.Body)('adjustmentType')),
